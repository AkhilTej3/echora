      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-[#282828] rounded-full text-white font-semibold text-sm hover:border-white transition-colors"
          >
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-[#b3b3b3] uppercase">or</span>
          <div className="flex-1 h-px bg-[#282828]" />
        </div>
